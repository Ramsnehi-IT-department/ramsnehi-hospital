<ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu" aria-labelledby="dropdown02">
            <li><a class="dropdown-item"
                    href="/patientCare">{{ __('homepage.careCenter_facilities') }}</a></li>
            <li><a class="dropdown-item"
    ...
    <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu" aria-labelledby="dropdown02">
            ...
            <li class="dropdown dropdown-submenu dropright">
                <a class="dropdown-item dropdown-toggle" href="/clinicalServices" id="dropdown0301" role="button"
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdown0301">
                    ...
                    <li><a class="dropdown-item"
                            href="/generalMedicine">{{ __('homepage.department_medicine') }}</a>
                    </li>
                    <li><a class="dropdown-item"
                            href="/generalSurgery">{{ __('homepage.department_surgery') }}</a>
                    </li>
                    <li><a class="dropdown-item"
                            href="/neuroSurgery">{{ __('homepage.department_neuroSurgery') }}</a>
                    </li>
                    <li><a class="dropdown-item"
                    ...
                    <li><a class="dropdown-item"
                            href="/Paediatric">{{ __('homepage.department_paediatrics') }}</a>
    ...
    <li class="dropdown dropdown-submenu dropright">
        ...
        <ul class="dropdown-menu" aria-labelledby="dropdown0301">
            ...
            <li><a class="dropdown-item"
                    href="/ultrasound">{{ __('homepage.department_ultrasound') }}</a>
            </li>
    ...
    <li class="dropdown dropdown-submenu dropright">
        ...
        <ul class="dropdown-menu" aria-labelledby="dropdown0301">
            ...
            <li><a class="dropdown-item"
                    href="/haematology">{{ __('homepage.department_haematology') }}</a>
            </li>
            <li><a class="dropdown-item"
                    href="/histopathology">{{ __('homepage.department_histopathology') }}</a>
            </li>
        </ul>
    </li>
    ...
    <li class="dropdown dropdown-submenu dropright">
        ...
        <ul class="dropdown-menu" aria-labelledby="dropdown0301">
            ...
            <li><a class="dropdown-item"
                    href="/bloodBank">{{ __('homepage.department_bloodBank') }}</a></li>
        </ul>
    </li>
    ...
    <li class="dropdown dropdown-submenu dropright">
        ...
        <ul class="dropdown-menu" aria-labelledby="dropdown0301">
            ...
            <li><a class="dropdown-item"
                    href="/ambulance">{{ __('homepage.department_ambulance') }}</a></li>
            <li><a class="dropdown-item"
                    href="/dietetics">{{ __('homepage.department_dietetics') }}</a></li>
            <li><a class="dropdown-item"
...
<li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu" aria-labelledby="dropdown02">
        ...
        <li><a class="dropdown-item"
                href="/hospitalEvents">{{ __('homepage.events_hospitalEvents') }}</a></li>
...
<li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu" aria-labelledby="dropdown02">
        <li><a class="dropdown-item"
                href="/allMediaCoverage">{{ __('homepage.media_menu_allMediaCoverage') }}</a>
        </li>
        <li><a class="dropdown-item"
                href="/doctorsDesk">{{ __('homepage.media_menu_doctorDesk') }}</a></li>
        <li><a class="dropdown-item" href="/printMedia">{{ __('homepage.media_menu_printMedia') }}</a>
        </li>
        <li><a class="dropdown-item"
                href="/digitalMedia">{{ __('homepage.media_menu_digitalMedia') }}</a></li>
    </ul>
</li>
{{-- Media Coverage end --}}
