          ...
          <div class="row">
              <div class="col-lg-4 col-md-6 ">
                  <div class="department-block mb-5">
                      ...
                      <div class="content">
                          ...
                          <a href="/neuroSurgery" class="read-more">Learn More  <i class="icofont-simple-right ml-2"></i></a>
                      </div>
                  </div>
              </div>
              ...
              <div class="col-lg-4 col-md-6">
                  <div class="department-block mb-5">
                      ...
                      <div class="content">
                          <h4 class="mt-4 mb-2  title-color">Cardiology Department</h4>
                          <p class="mb-4">Saepe nulla praesentium eaque omnis perferendis a doloremque.</p>
                          <a href="/cardiologyDepartment" class="read-more">Learn More <i class="icofont-simple-right ml-2"></i></a>
                      </div>
                  </div>
              </div>
              ...
              <div class="col-lg-4 col-md-6">
                  <div class="department-block mb-5">
                      ...
                      <div class="content">
                          ...
                          <p class="mb-4">Saepe nulla praesentium eaque omnis perferendis a doloremque.</p>
                          <a href="/orthopedic" class="read-more">Learn More <i class="icofont-simple-right ml-2"></i></a>
                      </div>
                  </div>
              </div>
              ...
              <div class="col-lg-4 col-md-6 ">
                  <div class="department-block  mb-5 mb-lg-0">
                      ...
                      <div class="content">
                          ...
                          <p class="mb-4">Saepe nulla praesentium eaque omnis perferendis a doloremque.</p>
                          <a href="/ophthalmology" class="read-more">Learn More <i class="icofont-simple-right ml-2"></i></a>
                      </div>
                  </div>
              </div>
              ...
              <div class="col-lg-4 col-md-6">
                  <div class="department-block mb-5 mb-lg-0">
                      ...
                      <div class="content">
                          ...
                          <p class="mb-4">Saepe nulla praesentium eaque omnis perferendis a doloremque.</p>
                          <a href="/Pediatric" class="read-more">Learn More <i class="icofont-simple-right ml-2"></i></a>
                      </div>
                  </div>
              </div>
              ...
              <div class="col-lg-4 col-md-6">
                  <div class="department-block mb-5 mb-lg-0">
                      ...
                      <div class="content">
                          ...
                          <p class="mb-4">Saepe nulla praesentium eaque omnis perferendis a doloremque.</p>
                          <a href="/gynecology" class="read-more">Learn More <i class="icofont-simple-right ml-2"></i></a>
                      </div>
                  </div>
              </div>
              ...
              <div class="col-lg-4 col-md-6 ">
                <div class="department-block  mb-5 mb-lg-0">
                    <img src="images/service/service-4.jpg" alt="" class="img-fluid w-100">
                    <div class="content">
                        <h4 class="mt-4 mb-2 title-color">Ear Nose Throat</h4>
                        <p class="mb-4">Saepe nulla praesentium eaque omnis perferendis a doloremque.</p>
                        <a href="/ent" class="read-more">Learn More <i class="icofont-simple-right ml-2"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="department-block mb-5 mb-lg-0">
                    ...
                    <div class="content">
                        ...
                        <p class="mb-4">Saepe nulla praesentium eaque omnis perferendis a doloremque.</p>
                        <a href="/generalSurgery" class="read-more">Learn More <i class="icofont-simple-right ml-2"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="department-block mb-5 mb-lg-0">
                    ...
                    <div class="content">
                        ...
                        <p class="mb-4">Saepe nulla praesentium eaque omnis perferendis a doloremque.</p>
                        <a href="/jointReplacementSurgery" class="read-more">Learn More <i class="icofont-simple-right ml-2"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="department-block mb-5 mb-lg-0">
                    ...
                    <div class="content">
                        ...
                        <p class="mb-4">Saepe nulla praesentium eaque omnis perferendis a doloremque.</p>
                        <a href="/generalMedicine" class="read-more">Learn More <i class="icofont-simple-right ml-2"></i></a>
                    </div>
                </div>
            </div>
          </div>
