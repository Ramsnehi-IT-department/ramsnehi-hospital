...
<section class="page-title bg-1">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="block">
                    <h1 class="text-capitalize text-lg">Diagnostic Services</h1>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-4">
                    <div class="card custom-card mb-4">
                        <a href="/ECG">
                            <img class="card-img-top" src="images/service/service-3.jpg" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title" style="font-size: 1rem;">Endoscopy</h5>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card custom-card mb-4">
                        <a href="/DSALab">
                            <img class="card-img-top" src="images/service/service-2.jpg" alt="Card image cap">
                            <div class="card-body">
                                <h5 class="card-title">Cath Lab</h5>
                            </div>
                        </a>
                    </div>
                </div>
