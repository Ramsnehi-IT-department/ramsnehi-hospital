...
@section('title', 'GENERAL MEDICINE')
@section('content')
            ...
            <div class="col-md-12">
                <div class="block">
                    <ul class="list-inline">
                        ...
                        <li class="list-inline-item"><span class="text-white">/</span></li>
                        <li class="list-inline-item"><a href="/generalMedicine" class="text-white-50">Department Details</a></li>
                    </ul>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <p>Three full-time Specialist Physicians are regularly serving here, under this department-</p>
                <ul>
                    <li>Recruitment facility for 24-hour patients.</li>
