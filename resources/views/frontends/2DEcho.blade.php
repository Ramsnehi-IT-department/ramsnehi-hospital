            ...
            <div class="col-md-12">
                <div class="block">
                    <ul class="list-inline">
                        ...
                        <li class="list-inline-item"><span class="text-white">/</span></li>
                        <li class="list-inline-item"><a href="/2DEcho" class="text-white-50">Department Details</a></li>
                    </ul>
                    <h1 class="text-capitalize mb-5 text-lg">2D Echo</h1>
                </div>
            </div>
        </div>
    </div>
