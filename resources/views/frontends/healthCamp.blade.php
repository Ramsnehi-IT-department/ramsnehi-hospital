        ...
        <div class="row">
            <div class="col-md-12">
                <div class="block">
                    ...
                    <h1 class="text-capitalize mb-5 text-lg">Health Camps</h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-4">
                <div class="card custom-card mb-4">
                    <a href="#">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Health Camp 1</h5>
                        </div>
                    </a>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card custom-card mb-4">
                    <a href="#">
                        <img class="card-img-top" src="images/service/service-1.jpg" alt="Card image cap">
                        <div class="card-body">
                            <h5 class="card-title">Health Camp 2</h5>
                        </div>
                    </a>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card custom-card mb-4">
                    <a href="#">
                        <img class="card-img-top" src="images/service/service-1.jpg" alt="Card image cap">
                        <div class="card-body">
                            <h5 class="card-title">Health Camp 3</h5>
                        </div>
                    </a>
                </div>
            </div>
