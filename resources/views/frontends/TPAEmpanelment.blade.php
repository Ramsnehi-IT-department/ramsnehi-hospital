            ...
            <div class="col-md-12">
                <div class="block">
                    <ul class="list-inline">
                        ...
                        <li class="list-inline-item"><span class="text-white">/</span></li>
                        <li class="list-inline-item"><a href="/TPAEmpanelment" class="text-white-50">Details</a></li>
                    </ul>
                    <h1 class="text-capitalize mb-5 text-lg">TPA Empanelment</h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-4">
                <div class="card custom-card mb-4">
                    <a href="#">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Government Schemes 1</h5>
                        </div>
                    </a>
                </div>
            </div>
