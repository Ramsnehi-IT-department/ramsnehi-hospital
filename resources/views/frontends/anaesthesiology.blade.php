            ...
            <div class="col-md-12">
                <div class="block">
                    <ul class="list-inline">
                        ...
                        <li class="list-inline-item"><span class="text-white">/</span></li>
                        <li class="list-inline-item"><a href="/anaesthesiology" class="text-white-50">Department Details</a></li>
                    </ul>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <p>Wipro GE Company's high-tech Kethleb and cardiac ICU for specialized services for heart disease in the hospital. Has been established. Through which angiography and angioplasty are being done here regularly, the work of applying pacemakers has also been done successfully here. Starting from 3 December 2014, 1622 angiography and 381 angioplasty have also been done in this department as well as installation of pace maker.</p>
