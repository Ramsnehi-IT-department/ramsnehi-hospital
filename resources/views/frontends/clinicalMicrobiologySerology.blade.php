...
@section('title', 'Clinical Microbiology and Serology')
@section('content')
            ...
            <div class="col-md-12">
                <div class="block">
                    <ul class="list-inline">
                        ...
                        <li class="list-inline-item"><span class="text-white">/</span></li>
                        <li class="list-inline-item"><a href="/laboratoryServices" class="text-white-50">Laboratory
                                Services</a></li>
                        <li class="list-inline-item"><span class="text-white">/</span></li>
                    </ul>
                    <h1 class="text-capitalize mb-5 text-lg">Clinical Microbiology and Serology</h1>
                </div>
            </div>
        </div>
    </div>
